Coffeemaker.core.capacities.load = function (uri,args,callback) {
    ...
    var getContent = function(url,ext) {
        ...
        if (check.inArray(url,Coffeemaker.core.capacities.load.loaded)) return;
            ...
            var CBK = function(data) {
                if( data = JSON.parse(data) ) {
                    if (data.structure) {
                        ...
                        loop.object.recursive(data.structure, function(a,b,c) {
                                    ...
                                    test('components/'+b, 'json', function() {
                                        trick(u,'json',function(bool) {
                                            ...
                                            if ( Coffeemaker.core.capacities.load.stack.length - Coffeemaker.core.capacities.load.loaded.length === 0 ) {
                                                ...
                                                console.log(Coffeemaker.components);
                                                ACTION(load(URI));
